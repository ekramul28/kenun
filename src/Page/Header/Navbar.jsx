...
const Navbar = () => {
    const link = <>
        ...
        <li className="font-semibold text-lg dark:text-white"><NavLink to="/product">Product</NavLink></li>
        <li className="font-semibold text-lg dark:text-white"><NavLink to="/deshbord">Deshbord</NavLink></li>
        <li className="font-semibold text-lg dark:text-white"><NavLink to="/login">Login</NavLink></li>
        <li className="font-semibold text-lg dark:text-white"><NavLink to="/card">Card</NavLink></li>
    </>
